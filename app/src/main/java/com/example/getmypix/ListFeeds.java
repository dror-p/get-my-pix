...
import com.example.getmypix.Models.Listeners;
...
import com.example.getmypix.Models.PostsListAdapter;
import com.example.getmypix.Models.PostsViewModel;
...
public class ListFeeds extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((MainActivity) getActivity()).getSupportActionBar().setTitle("GetMyPix! - Home");
